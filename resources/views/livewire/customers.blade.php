<div>
    <div class="row mt-4">  
        ...
        <div class="col-auto">
            <input wire:keydown.enter="search" wire:model='searchKey' type="text" class="form-control" placeholder="Search customers"/>
        </div>
    </div>  
            ...
            @foreach($customers as $customer)
                <tr>
                    ...
                    <td> 
                       ...
                       <button wire:click="destroy({{$customer->id}})" class="btn btn-danger btn-sm"> Delete</button> 
                    </td>
                </tr>
            @endforeach
        </tbody>
